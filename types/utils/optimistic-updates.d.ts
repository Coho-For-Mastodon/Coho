 ...
 */
export declare function dispatchToast(message: string, variant?: 'error' | 'warning' | 'info' | 'success'): void;
/**
 * Show an error toast
 */
 ...
 */
export declare function withOptimisticUpdate<T>(apply: () => void, execute: () => Promise<T>, rollback: () => void, options?: {
    errorMessage?: string;
    showToast?: boolean;
